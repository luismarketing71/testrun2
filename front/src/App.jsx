...
import BookingSuccess from "./pages/BookingSuccess"; // Added import
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <Link
                to="/book"
                className="bg-barber-gold hover:bg-yellow-600 text-black px-4 py-2 rounded-md text-sm font-bold uppercase tracking-wider transition-colors"
              >
                Book Now
              </Link>
            </div>
          ...
          <div className="-mr-2 flex md:hidden">
            <button
              ...
              className="text-white hover:text-barber-gold p-2"
            >
              {isOpen ? (
                <X className="h-6 w-6" />
              ) : (
        ...
        <div className="md:hidden bg-barber-black border-b border-white/10">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link
              ...
              className="block w-full text-center bg-barber-gold text-black px-3 py-3 rounded-md text-base font-bold uppercase mt-4"
            >
              Book Now
            </Link>
          </div>
...
function NavLink({ to, children, current }) {
  ...
  return (
    <Link
      to={to}
      className={`${isActive ? "text-barber-gold" : "text-gray-300 hover:text-white"} px-3 py-2 rounded-md text-sm font-medium transition-colors uppercase tracking-wide`}
    >
      {children}
    </Link>
  );
